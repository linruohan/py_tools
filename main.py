...
class App(ctk.CTk):
    ...
    def __init__(self) -> None:
        ...
        self.logo_image = ctk.CTkImage(Image.open(image_path / "ctk_logo_single.png"), size=(26, 26))
    ...
    def center_window(self, width, height):
        self.update_idletasks()  # 更新窗口，确保获取到最新的尺寸
