...
class AudioBackendsTab(BaseConfigTab):
    ...
    def _create_widgets(self):
        ...
        ctk.CTkLabel(backend_frame, text="音频后端类型:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=5)
        
        self.backend_types = ctk.CTkOptionMenu(
            backend_frame,
            values=["默认", "ALSA", "PulseAudio", "SPICE", "Dummy"]
        )
        ...
        ctk.CTkLabel(backend_props_frame, text="音频后端属性:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=5)
