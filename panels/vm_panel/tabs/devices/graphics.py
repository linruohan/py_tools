...
class GraphicsTab(BaseConfigTab):
    ...
    def _init_ui(self) -> None:
        ...
        ctk.CTkLabel(scroll_frame, text='Autoport:', font=CTK_FONT_MAIN, width=60).pack(
            side='left', padx=5, pady=2
        )
        ...
        ctk.CTkLabel(scroll_frame, text='Port:', font=CTK_FONT_MAIN, width=35).pack(
        ...
        ctk.CTkLabel(scroll_frame, text='Listen:', font=CTK_FONT_MAIN, width=45).pack(
            side='left', padx=3, pady=2
        )
        self.listen = ctk.CTkEntry(
            scroll_frame, placeholder_text='0.0.0.0', width=90, font=CTK_FONT_SMALL
        )
        ...
        self.tls_port = ctk.CTkEntry(
            scroll_frame, placeholder_text='-1', width=50, font=CTK_FONT_SMALL
        )
        ...
        ctk.CTkLabel(scroll_frame, text='Passwd:', font=CTK_FONT_MAIN, width=50).pack(
            side='left', padx=3, pady=2
        )
        self.passwd = ctk.CTkEntry(
            scroll_frame, placeholder_text='', width=100, font=CTK_FONT_SMALL, show='*'
        )
        self.passwd.pack(side='left', padx=2, pady=2)
        self.passwd.bind('<KeyRelease>', lambda e: self._trigger_change())

        ctk.CTkLabel(scroll_frame, text='Keymap:', font=CTK_FONT_MAIN, width=55).pack(
            side='left', padx=3, pady=2
        )
        self.keymap = ctk.CTkEntry(
            scroll_frame, placeholder_text='en-us', width=70, font=CTK_FONT_SMALL
        )
        ...
        ctk.CTkLabel(scroll_frame, text='Share:', font=CTK_FONT_MAIN, width=40).pack(
            side='left', padx=3, pady=2
        )
        ...
        ctk.CTkLabel(scroll_frame, text='Power:', font=CTK_FONT_MAIN, width=40).pack(
            side='left', padx=3, pady=2
        )
        ...
        ctk.CTkLabel(scroll_frame, text='Wait:', font=CTK_FONT_MAIN, width=35).pack(
            side='left', padx=3, pady=2
        )
        ...
        # SPICE 选项分隔线
        ctk.CTkLabel(scroll_frame, text='|', text_color='#666666').pack(
            side='left', padx=10, pady=2
        )
        ctk.CTkLabel(
            scroll_frame, text='SPICE:', font=CTK_FONT_BOLD, text_color='#ff9800', width=50
        ).pack(side='left', padx=3, pady=2)

        # SPICE 选项行
        ctk.CTkLabel(scroll_frame, text='Mode:', font=CTK_FONT_MAIN, width=40).pack(
            side='left', padx=3, pady=2
        )
        ...
        ctk.CTkLabel(scroll_frame, text='Compression:', font=CTK_FONT_MAIN, width=75).pack(
            side='left', padx=3, pady=2
        )
        ...
        ctk.CTkLabel(scroll_frame, text='Stream:', font=CTK_FONT_MAIN, width=50).pack(
            side='left', padx=3, pady=2
        )
        ...
        # SPICE 选项第二行
        ctk.CTkLabel(scroll_frame, text='Clipboard:', font=CTK_FONT_MAIN, width=60).pack(
            side='left', padx=3, pady=2
        )
        ...
        ctk.CTkLabel(scroll_frame, text='Mouse:', font=CTK_FONT_MAIN, width=45).pack(
            side='left', padx=3, pady=2
        )
        ...
        ctk.CTkLabel(scroll_frame, text='FileTransfer:', font=CTK_FONT_MAIN, width=75).pack(
            side='left', padx=3, pady=2
        )
    ...
    def get_config(self) -> dict:
        ...
        config = {
            ...
            'power_control': self.power_control.get()
            if self.graphics_type.get() == 'vnc'
            else None,
