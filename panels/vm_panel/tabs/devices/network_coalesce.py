...
class NetworkCoalesceTab(BaseConfigTab):
    """网络接口coalesce配置"""
    ...
    def _init_ui(self) -> None:
        ...
        ctk.CTkLabel(
            frame, text='Coalesce settings', font=CTK_FONT_BOLD, text_color='#795548'
        ...
        self.rx_coalesce.grid(row=1, column=1, padx=5, pady=5, sticky='w')
        ...
        self.tx_coalesce.grid(row=2, column=1, padx=5, pady=5, sticky='w')
        self.tx_coalesce.bind('<KeyRelease>', lambda e: self._trigger_change())
