...
class PanicDeviceTab(BaseConfigTab):
    ...
    def _create_widgets(self):
        ...
        ctk.CTkLabel(panic_frame, text='Panic设备配置:', font=ctk.CTkFont(weight='bold')).pack(
        ...
        ctk.CTkLabel(props_frame, text='Panic设备属性:', font=ctk.CTkFont(weight='bold')).pack(
            anchor='w', padx=10, pady=5
        )
        ...
        action_options = ctk.CTkOptionMenu(
            action_frame, variable=self.action_var, values=['pause', 'reset', 'shutdown', 'none']
        )
