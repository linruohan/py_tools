...
class PstoreTab(BaseConfigTab):
    ...
    def _create_widgets(self):
        ...
        ctk.CTkLabel(pstore_frame, text='Pstore设备配置:', font=ctk.CTkFont(weight='bold')).pack(
        ...
        ctk.CTkLabel(props_frame, text='Pstore设备属性:', font=ctk.CTkFont(weight='bold')).pack(
            anchor='w', padx=10, pady=5
        )
        ...
        type_options = ctk.CTkOptionMenu(
            type_frame, variable=self.type_var, values=['ramoops', 'pstore']
        )
