...
class RandomNumberGeneratorTab(BaseConfigTab):
    ...
    def _create_widgets(self):
        ...
        ctk.CTkLabel(rng_frame, text="随机数生成器配置:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=5)
        ...
        ctk.CTkLabel(props_frame, text="随机数生成器属性:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=5)
