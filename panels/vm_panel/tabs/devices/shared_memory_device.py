...
class SharedMemoryDeviceTab(BaseConfigTab):
    ...
    def _create_widgets(self):
        ...
        ctk.CTkLabel(shmem_frame, text="共享内存设备配置:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=5)
        ...
        ctk.CTkLabel(props_frame, text="共享内存属性:", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=5)
        ...
        ctk.CTkCheckBox(server_frame, text="作为服务器", variable=self.server_var).pack(side="left", padx=5, pady=5)
